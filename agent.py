...
if __name__ == "__main__":
    ...
    man = agent.manhattan_distance(start, goal)
    euc = agent.euclidean_distance(start, goal)

    print(f"Manhattan distance from {start} to {goal}: {man}")   # Expected: 7
    print(f"Euclidean distance from {start} to {goal}: {euc}")   # Expected: 5.0     